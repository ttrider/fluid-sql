...
namespace Tests.Sqlite
{
    ...
    public class SelectTest
    {
        ...
        public IStatement SelectStarFromSysObjects()
        {
            ...
            Assert.IsNotNull(text);
            Assert.AreEqual("SELECT * FROM \"sys\".\"objects\";", text);
            return statement;
        }
        ...
        public IStatement SelectSkipSchema()
        {
            ...
            Assert.IsNotNull(text);
            Assert.AreEqual("SELECT * FROM \"DB\"..\"objects\";", text);
            return statement;
        }
        ...
        public IStatement SelectSkipDbAndSchema()
        {
            ...
            Assert.IsNotNull(text);
            Assert.AreEqual("SELECT * FROM \"server\"...\"objects\";", text);
            return statement;
        }
        ...
        public IStatement SelectStarFromSysObjectsInto()
        {
            ...
            Assert.IsNotNull(text);
            Assert.AreEqual("CREATE TABLE \"#mytable\" AS SELECT * FROM \"sys\".\"objects\";", text);
            return statement;
        }
        ...
        public IStatement SelectCountStarFromSysObjects()
        {
            ...
            Assert.IsNotNull(text);
            Assert.AreEqual("SELECT COUNT( * ) FROM \"sys\".\"objects\";", text);
            return statement;
        }
        ...
        public IStatement SelectFoo()
        {
            ...
            Assert.IsNotNull(text);
            Assert.AreEqual("SELECT 'Foo1';", text);
            return statement;
        }
        ...
        public IStatement SelectParam1As()
        {
            ...
            Assert.IsNotNull(text);
            Assert.AreEqual("SELECT @param1 AS \"p1\";", text);
            return statement;
        ...
        public IStatement Select1Top1()
        {
            ...
            Assert.IsNotNull(text);
            Assert.AreEqual("SELECT 1 AS \"foo\" LIMIT 1;", text);
            return statement;
        }
        ...
        public IStatement SelectStarPlus()
        {
            ...
            Assert.IsNotNull(text);
            Assert.AreEqual("SELECT DISTINCT *;", text);
            return statement;
        }
        ...
        public IStatement SelectStarPlusPlus()
        {
            ...
            Assert.IsNotNull(text);
            Assert.AreEqual("SELECT \"src\".* FROM \"sys\".\"objects\" AS \"src\";", text);
            return statement;
        }
        ...
        public IStatement SelectUnionSelect()
        {
            ...
            Assert.IsNotNull(text);
            Assert.AreEqual("SELECT * FROM \"sys\".\"objects\" UNION SELECT * FROM \"sys\".\"objects\";", text);
            return statement;
        }
        ...
        public IStatement SelectUnionAllSelect()
        {
            ...
            Assert.IsNotNull(text);
            Assert.AreEqual("SELECT * FROM \"sys\".\"objects\" UNION ALL SELECT * FROM \"sys\".\"objects\";", text);
            return statement;
        }
        ...
        public IStatement SelectExceptSelect()
        {
            ...
            Assert.IsNotNull(text);
            Assert.AreEqual("SELECT * FROM \"sys\".\"objects\" EXCEPT SELECT * FROM \"sys\".\"objects\";", text);
            return statement;
        }
