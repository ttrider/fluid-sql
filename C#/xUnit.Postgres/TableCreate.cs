...
namespace xUnit.Postgres
{
    public class TableCreate : PostgreSqlProviderTests
    {
        ...
        public void CreateTableWithIndex()
        {
            ...
            Assert.NotNull(command);
            Assert.Equal("CREATE TABLE \"tbl\" ( \"C1\" SERIAL NOT NULL, \"C2\" TEXT NULL, CONSTRAINT \"PK_tbl\" PRIMARY KEY ( \"C1\" ) );\r\nCREATE INDEX \"IX_tbl\" ON \"tbl\" ( \"C2\" ASC );", command.CommandText);
        }
        ...
        public void CreateTableWithIndexIfNotExists()
        {
            ...
            Assert.NotNull(command);
            Assert.Equal("CREATE TABLE IF NOT EXISTS \"tbl\" ( \"C1\" SERIAL NOT NULL, \"C2\" TEXT NULL, CONSTRAINT \"PK_tbl\" PRIMARY KEY ( \"C1\" ) );\r\nCREATE INDEX \"IX_tbl\" ON \"tbl\" ( \"C2\" ASC );", command.CommandText);
        }
