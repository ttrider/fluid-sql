...
{
    public class Select : PostgreSqlProviderTests
    {
        [Fact]
        ...
        public void SelectOrderBy()
        {
            ...
            Assert.NotNull(text);
            Assert.Equal("SELECT \"id\" FROM \"table1\" ORDER BY \"id\" ASC;", text);
        }
        ...
        public void SelectGroupBy()
        {
            ...
            Assert.NotNull(text);
            Assert.Equal("SELECT \"id\" FROM \"table1\" GROUP BY \"id\" ORDER BY \"id\" ASC;", text);
        }
        ...
        public void SelectGroupByHaving()
        {
            ...
            Assert.NotNull(text);
            Assert.Equal("SELECT \"id\" FROM \"table1\" GROUP BY \"id\", \"value\" HAVING \"value\" = 'val8';", text);
        }
        ...
        public void Select1OffsetFetch()
        {
            ...
            Assert.NotNull(command);
            Assert.Equal("SELECT * FROM \"public\".\"tbl1\" AS \"foo\" ORDER BY \"C1\" ASC LIMIT 10 OFFSET 100;", command.CommandText);
        }
        ...
        public void SelectGroupBy1()
        {
            ...
            Assert.NotNull(command);
            Assert.Equal("SELECT \"at1\".\"C1\" FROM \"public\".\"tbl1\" AS \"at1\" GROUP BY \"at1\".\"C1\", \"at1\".\"C2\";", command.CommandText);
        }
        ...
        public void SelectGroupByHaving1()
        {
            ...
            Assert.NotNull(command);
            Assert.Equal("SELECT \"src\".\"C1\" FROM \"public\".\"tbl1\" AS \"src\" GROUP BY \"src\".\"C1\", \"src\".\"C2\" HAVING \"src\".\"C1\" IS NULL;", command.CommandText);
        }
        ...
        public void SelectOrderBy1()
        {
            ...
            Assert.NotNull(command);
            Assert.Equal("SELECT \"src\".\"C1\" FROM \"public\".\"tbl1\" AS \"src\" ORDER BY \"src\".\"C1\" ASC, \"src\".\"C2\" DESC;", command.CommandText);
        }
