...
namespace xUnit.Functional
{
    static class Common
    {
        ...
        internal static IEnumerable<IStatement> CreateParameterizedStatements()
        {
            var v =
                Sql.Select.Output(Sql.Parameter.BigInt("@p1"), Sql.Parameter.String("@p2"), Sql.Star()).From("ach.City");
            v.ParameterValues.Add("@p1", 1234);
            v.ParameterValues.Add("@p2", "9876");
